...
export const EDITOR_DENSITY_PRESETS = {
  default: {
    ...
    /** Narrow track header column on small viewports (matches former w-24). */
    timelineSidebarWidthMobile: 96,
...
const EDITOR_LAYOUT_CSS_VAR_NAMES = {
  ...
  timelineSidebarWidthMobile: '--editor-timeline-sidebar-width-mobile',
...
export const EDITOR_LAYOUT_CSS_VALUES = {
  ...
  timelineSidebarWidthMobile: `var(${EDITOR_LAYOUT_CSS_VAR_NAMES.timelineSidebarWidthMobile})`,
...
export function getEditorLayoutCssVars(layout = EDITOR_LAYOUT): Record<string, string> {
  return {
    ...
    [EDITOR_LAYOUT_CSS_VAR_NAMES.timelineSidebarWidthMobile]: `${layout.timelineSidebarWidthMobile}px`,
