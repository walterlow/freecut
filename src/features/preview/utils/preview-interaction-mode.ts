export type PreviewInteractionMode = 'playing' | 'gizmo_dragging' | 'scrubbing' | 'paused'
...
export function getPreviewInteractionMode(input: PreviewInteractionInput): PreviewInteractionMode {
