...
export const PREVIEW_RENDERER_ENABLED = true;
export const PREVIEW_RENDERER_PRELOAD_BUDGET_MS = 180;
export const PREVIEW_RENDERER_BOUNDARY_PREWARM_WINDOW_SECONDS = 0.5;
export const PREVIEW_RENDERER_MAX_PREWARM_FRAMES = 256;
export const PREVIEW_RENDERER_MAX_PREWARM_SOURCES = 96;
export const PREVIEW_RENDERER_SOURCE_PREWARM_WINDOW_SECONDS = 1.0;
export const PREVIEW_RENDERER_BOUNDARY_PREWARM_MAX_BOUNDARIES_PER_FRAME = 2;
export const PREVIEW_RENDERER_BOUNDARY_SOURCE_PREWARM_MAX_ENTRIES_PER_FRAME = 2;
export const PREVIEW_RENDERER_BOUNDARY_SOURCE_PREWARM_MAX_SOURCES_PER_FRAME = 6;
export const PREVIEW_RENDERER_SOURCE_TOUCH_COOLDOWN_FRAMES = 6;
export const PREVIEW_RENDERER_DISABLE_BACKGROUND_PREWARM_ON_BACKWARD = true;
export const PREVIEW_RENDERER_DIRECTIONAL_PREWARM_FORWARD_STEPS = 3;
export const PREVIEW_RENDERER_DIRECTIONAL_PREWARM_BACKWARD_STEPS = 2;
export const PREVIEW_RENDERER_DIRECTIONAL_PREWARM_OPPOSITE_STEPS = 0;
export const PREVIEW_RENDERER_DIRECTIONAL_PREWARM_NEUTRAL_RADIUS = 1;
export const PREVIEW_RENDERER_PREWARM_QUEUE_MAX = 24;
export const PREVIEW_RENDERER_TRANSITION_RENDER_AHEAD_MAX_FRAMES = 4;
export const PREVIEW_RENDERER_TRANSITION_RENDER_AHEAD_QUEUE_MAX = 12;
export const PREVIEW_RENDERER_BACKWARD_RENDER_THROTTLE_MS = 24;
...
export type PreviewRendererBoundarySource = { frame: number; srcs: string[] };
export type PreviewPerfSnapshot = {
  ...
  staleRendererFrameDrops: number;
